...
if (!isNil "_roleInList") then {
  //["SR _roleInList:", _roleInList] call MIV_fnc_log;
...
//["SR _roleWithPlatoon:",_roleWithPlatoon] call MIV_fnc_log;
...
if (!isNil "_roleWithPlatoon") then {
  //["BASE _roleWithPlatoon:",_roleWithPlatoon] call MIV_fnc_log;
