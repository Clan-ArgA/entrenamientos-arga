...
TEMPLATE_LAST_UPDATE = "2025-2-18";                  // Escribir la fecha en formato AAAA-M-D sin ceros en el mes o el día.
...
BOX_ROLE_LIST = ["Mayor","Capitán","Teniente","Líder","Sub Líder","Líder Pelotón","Líder Escuadra","Líder Escuadra 1","Líder Escuadra 2","Líder Escuadra 3","Ametrallador M240","Ametrallador M249","Amunicionador","Francotirador","Fusilero","Fusilero RA","Granadero","Granadero c/Bengalas","Ingeniero","Lanzador AA","Lanzador AT","Observador","Piloto","Radio Operador","Tirador FAL","Tirador MK11","Tirador MK17","Médico","Médico de Combate","Enfermero"];
