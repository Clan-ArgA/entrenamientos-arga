...
INTRO = "core\scripts_entrenamiento\intro_aspirantes.sqf";                                          // Intros: 1 y 2. Para desactivar: 0
...
GPS = 0;                                            // 1: Agrega GPS vanilla en rol automático o caja, 0: Remueve.
