...
RB_TIEMPO_ESPERA_HOMBRES = 300;                     // Tiempo en segundos de espera para eliminar soldados enemigos. 0 Desactiva el borrado de enemigos
...
DIFICULTAD_IA_PERSONALIZADA = 1;                    // 1: Activada. 0: Desactivada.
